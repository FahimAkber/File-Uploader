...
public class QuartzJobServiceTest {
    ...
    void saveJob() throws SchedulerException {
        RequestJob requestJob = new RequestJob("Inward File Uploader", "File import from PBM simultaneously.", 3);
    ...
    void saveJobForError() throws SchedulerException {
        RequestJob requestJob = new RequestJob("Test Key", "Test Description", 1);
    ...
    @Test
    void updateJob(){
        RequestJob job = new RequestJob("Test key", "Test Description", 0);
